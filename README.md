...
python image_classification.py [site_name] [start_date] [end_date] [download_directory]
...
After the images have been downloaded, the program will open each photo in succession and prompt you to rate them on how much fog is present. The results will be stored in a .csv file created in the same directory as the images.
